...
// .wrangler/tmp/bundle-kf9mdu/strip-cf-connecting-ip-header.js
...
// src/worker.js
var AIRPORTS_CSV = "https://davidmegginson.github.io/ourairports-data/airports.csv";
var METAR_API = "https://aviationweather.gov/api/data/metar";
var TILE_SERVER = "https://tile.openstreetmap.org";
var MAX_TILE_ZOOM = 19;
var airportCache = null;
function cleanIcao(value) {
  return String(value || "").toUpperCase().replace(/[^A-Z0-9]/g, "").slice(0, 4);
}
__name(cleanIcao, "cleanIcao");
...
async function loadAirports() {
  ...
  if (!response.ok)
    throw new Error("Could not load airport database.");
  ...
  async fetch(request, env2, ctx) {
    ...
    if (pathname.startsWith("/tiles/")) {
      ...
      if (file && file.endsWith(".png")) {
        ...
        const xNum = Number(x);
        const yNum = Number(y);
        if (Number.isInteger(zNum) && Number.isInteger(xNum) && Number.isInteger(yNum) && zNum >= 0 && zNum <= MAX_TILE_ZOOM && xNum >= 0 && yNum >= 0) {
    ...
    if (pathname === "/" || pathname === "/index.html" || hasExtension) {
      try {
        ...
        if (pathname === "/" || pathname === "/index.html") {
          try {
            return await env2.ASSETS.fetch(new Request(new URL("/index.html", request.url).toString()));
          } catch (e) {
...
// .wrangler/tmp/bundle-kf9mdu/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-kf9mdu/middleware-loader.entry.ts
